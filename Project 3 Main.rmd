...
theUrl <- "https://raw.githubusercontent.com/kamathvk1982/PublishedDocuments/master/indeed_job_dataset.csv"
job.indeed.full.df <- read.csv(file = theUrl, header = T , sep = ',', na.strings=c("NA","NaN", "") )

job.indeed.df  <- job.indeed.full.df %>%
