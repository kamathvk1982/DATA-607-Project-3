...
### Programatically reading through the job-descriptions to extract mentions of the 'soft-skills'
...
#create data frames that have social skills by salary and jobtype
...
#### We will connect to the sampel database named "jMsCGxUGVV"  created on cloud MySql [https://remotemysql.com/]
